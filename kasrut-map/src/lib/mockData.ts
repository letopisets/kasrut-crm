...
export const MOCK_RESTAURANTS: MapRestaurant[] = [
  // Jerusalem
  {
    ...
    lat: 31.7796, lng: 35.2257, foodType: 'dairy', kashrutLevel: 'mehadrin',
  ...
  },
  {
    ...
    lat: 31.7839, lng: 35.2129, foodType: 'meat', kashrutLevel: 'badatz',
  ...
  },
  {
    ...
    lat: 31.7757, lng: 35.2340, foodType: 'pareve', kashrutLevel: 'mehadrin',
  ...
  },
  {
    ...
    lat: 31.7812, lng: 35.2168, foodType: 'pareve', kashrutLevel: 'regular',
  ...
  },
  {
    ...
    lat: 31.7843, lng: 35.2117, foodType: 'takeaway', kashrutLevel: 'regular',
    hechsher: 'רב"ד ירושלים', hours: 'א׳–ה׳ 8:00–19:00, ו׳ 8:00–14:00',
  },
  {
    id: 'm6', name: 'מסעדת שמשון', address: "רח' שמשון 8", city: 'Jerusalem',
    lat: 31.7720, lng: 35.2310, foodType: 'meat', kashrutLevel: 'mehadrin',
  ...
  // Haifa
  {
    ...
    lat: 32.8156, lng: 34.9893, foodType: 'dairy', kashrutLevel: 'regular',
    hechsher: 'רב"ד חיפה', phone: '04-855-7777',
    hours: 'א׳–ה׳ 11:00–23:00',
  },
  {
    id: 'm8', name: 'שוק הבשר', address: "שוק תלפיות 1", city: 'Haifa',
    lat: 32.8073, lng: 34.9942, foodType: 'meat', kashrutLevel: 'mehadrin',
  ...
  },
  {
    ...
    lat: 32.7963, lng: 34.9892, foodType: 'pareve', kashrutLevel: 'regular',
  ...
  // Tzfat
  {
    ...
    lat: 32.9641, lng: 35.4956, foodType: 'meat', kashrutLevel: 'mehadrin',
    hechsher: 'בד"ץ ק. צפת', phone: '04-697-1414',
    hours: 'א׳–ה׳ 12:00–22:00',
  },
  {
    id: 'm15', name: 'בית לחם גליל', address: "רח' ירושלים 3", city: 'Tzfat',
    lat: 32.9666, lng: 35.4970, foodType: 'dairy', kashrutLevel: 'regular',
  ...
  // Tiberias
  {
    ...
    lat: 32.7944, lng: 35.5271, foodType: 'dairy', kashrutLevel: 'regular',
    hechsher: 'רב"ד טבריה', phone: '04-672-1616',
    hours: 'כל יום 7:00–22:00',
  },
  {
    id: 'm17', name: 'דגי הכנרת', address: "טיילת טבריה 20", city: 'Tiberias',
    lat: 32.7912, lng: 35.5247, foodType: 'pareve', kashrutLevel: 'mehadrin',
  ...
  // Bnei Brak
  {
    ...
    lat: 32.0851, lng: 34.8285, foodType: 'meat', kashrutLevel: 'badatz',
    hechsher: 'בד"ץ בני ברק', phone: '03-618-1818',
    hours: 'א׳–ה׳ 10:00–22:00',
  },
  {
    id: 'm19', name: 'מאפיית הזהב', address: "רח' רבי עקיבא 60", city: 'Bnei Brak',
    lat: 32.0832, lng: 34.8314, foodType: 'takeaway', kashrutLevel: 'mehadrin',

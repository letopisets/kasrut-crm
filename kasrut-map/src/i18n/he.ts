...
const he: MapTranslations = {
  ...
  geoDenied: 'הגישה למיקום כבויה — מציגים מקומות לפי האזור המשוער. אפשר לסמן מיקום ידנית.',
  geoUnavailable: 'לא ניתן לאתר את מיקומך — מציגים מקומות לפי האזור המשוער.',
  ...
  foodTypeAny: 'לא צוין',
  categoryField: 'סוג עסק',
  categoryAny: 'לא צוין',
  category: { restaurant: 'מסעדה', bakery: 'מאפייה', cafe: 'קפה' },

...
const en: MapTranslations = {
  ...
  foodTypeField: 'Cuisine type',
  foodTypeAny: 'Not specified',
  categoryField: 'Establishment kind',
  categoryAny: 'Not specified',
  category: { restaurant: 'Restaurant', bakery: 'Bakery', cafe: 'Cafe' },
  imageField: 'Teudat kashrut photo',
  imageHint: 'JPEG, PNG or WebP. The image is downscaled before sending.',
  imageAdd: 'Add photo',
  imageAddCamera: 'Take photo',
  imageAddGallery: 'From gallery',
  imageRemove: 'Remove photo',
  imageProcessing: 'Processing…',
  imageError: 'Could not process the image. Try a different photo.',
  kashrutPhotoNotice: 'To confirm the establishment is kosher, please attach a photo of the teudat kashrut.',
  kashrutPhotoRequired: 'To add this place, attach a photo of the teudat kashrut — it confirms the establishment is kosher.',
  notesField: 'Comment',

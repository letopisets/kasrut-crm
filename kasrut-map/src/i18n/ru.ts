...
const ru: MapTranslations = {
  ...
  geoDenied: 'Доступ к геолокации выключен — показываем заведения по приблизительному району. Можно указать точку вручную.',
  geoUnavailable: 'Не удалось определить местоположение — показываем заведения по приблизительному району.',

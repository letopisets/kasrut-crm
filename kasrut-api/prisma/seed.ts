...
async function main() {
  ...
  // ── Kashrut Levels ─────────────────────────────────────────────────────────
  await prisma.kashrutLevel.createMany({ data: [
  ...
  await prisma.restaurant.createMany({ data: [
    { id: 'r1', name: 'מסעדת הגורמה',     address: "רח' יפו 42",      city: 'Jerusalem', levelId: 'kl_mehadrin',    hechsherId: 'h1', mashgiachId: m1.id, kitniyot: false, expires: new Date('2026-03-15'), status: 'warning',  notes: '',                   rabbanutId: rb1.id, lat: 31.7834, lng: 35.2137, foodType: 'meat',     phone: '02-623-1111', hours: 'א׳–ה׳ 12:00–22:00' },
    { id: 'r2', name: 'בית האוכל המרכזי', address: "רח' בן יהודה 18", city: 'Jerusalem', levelId: 'kl_regular',     hechsherId: 'h2', mashgiachId: m2.id, kitniyot: true,  expires: new Date('2026-06-30'), status: 'ok',       notes: '',                   rabbanutId: rb1.id, lat: 31.7820, lng: 35.2145, foodType: 'pareve',   phone: '02-624-2222', hours: 'א׳–ה׳ 9:00–21:00, ו׳ 9:00–14:00' },
    { id: 'r3', name: 'מסעדת צפון',       address: "שד' הרצל 55",     city: 'Haifa',     levelId: 'kl_mehadrin',    hechsherId: 'h4', mashgiachId: m3.id, kitniyot: false, expires: new Date('2026-02-28'), status: 'critical', notes: 'Requires attention', rabbanutId: rb2.id, lat: 32.8156, lng: 34.9893, foodType: 'meat',     phone: '04-855-3333', hours: 'א׳–ה׳ 12:00–23:00' },
    { id: 'r4', name: 'פיצה שמש',         address: "רח' גאולה 31",    city: 'Haifa',     levelId: 'kl_lo_mehadrin', hechsherId: 'h3', mashgiachId: m1.id, kitniyot: true,  expires: new Date('2026-08-10'), status: 'ok',       notes: '',                   rabbanutId: rb2.id, lat: 32.8073, lng: 34.9942, foodType: 'dairy',    phone: '04-851-4444', hours: 'א׳–ה׳ 11:00–23:00' },
    { id: 'r5', name: 'המאפייה העתיקה',   address: "רח' ירושלים 17",  city: 'Tzfat',     levelId: 'kl_mehadrin',    hechsherId: 'h5', mashgiachId: m4.id, kitniyot: false, expires: new Date('2026-04-01'), status: 'warning',  notes: '',                   rabbanutId: rb1.id, lat: 32.9641, lng: 35.4956, foodType: 'dairy',    phone: '04-697-5555', hours: 'א׳–ה׳ 8:00–21:00, ו׳ 8:00–14:00' },
    { id: 'r6', name: 'מלון כנרות',       address: "רח' זיידל 9",     city: 'Tiberias',  levelId: 'kl_regular',     hechsherId: 'h1', mashgiachId: m2.id, kitniyot: false, expires: new Date('2026-09-20'), status: 'ok',       notes: '',                   rabbanutId: rb1.id, lat: 32.7944, lng: 35.5271, foodType: 'takeaway', phone: '04-672-6666', hours: 'כל יום 7:00–22:00' },
  ] })
